# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2019-04-01 06:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stone_image', models.ImageField(null=True, upload_to='businesses')),
                ('stone_number', models.CharField(max_length=10)),
        ...
        migrations.AddField(
            model_name='receipt',
            name='room_number',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='stone', to='stone.Stone'),
        ),
    ]
